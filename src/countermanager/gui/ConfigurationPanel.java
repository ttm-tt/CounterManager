...
public class ConfigurationPanel extends javax.swing.JPanel {
    ...
    private void addLivetickerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addLivetickerButtonActionPerformed
        Object ret = javax.swing.JOptionPane.showInputDialog(
                this, null, null, JOptionPane.PLAIN_MESSAGE, null, new String[] {"TTM", "Unas", "Scripting", "Atos"}, "TTM"
        );
        ...
        switch (ret.toString()) {
            ...
            case "Atos" :
                LivetickerAdmininstration.addLiveticker(new countermanager.liveticker.atos.Atos());
                break;
